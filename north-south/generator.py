...
def  generate_graph(n : int, extra_edges : int = 0 , m : int=None, random_shuffle : bool = False) -> list[tuple[int, int]]:
    """
    ...
    #     edges.append((random.choice(cities), random.choice(cities)))
